...
本报告以计算机伦理为核心框架，结合真实案例，对医疗AI的社会影响、监管平衡、伦理问题及治理策略进行系统分析，并提出个人主张与建议。"""),
...
("1. 成因分析",
"""公平性是计算机伦理的核心价值之一，涵盖机会平等与结果平等两个层面。对于医疗AI而言，算法偏见的根源通常存在于三个环节：
...
("1. 四个层面的风险分析",
"""复杂技术系统的伦理风险往往不是静态的，而是随着技术的开发、部署与使用动态演化的。以"联邦学习联合诊断模型"为例，该技术通过在多个医疗机构间协作训练模型而不集中传输原始数据，其风险可能出现在以下四个层面：
